	...
	<div class="info-wrap-empty">
		...
		<div class="info-content-empty">
			<div class="icon-empty">
				<?php echo wp_kses_post($html_search_icon); ?>
			</div>
			<div class="info-empty">
				<?php echo wp_kses_post($html404); ?>
				<p class="cart-empty-text"><?php esc_html_e( 'Nothing was found', 'dfd' ) ?></p>
				<p class="cart-empty-subtext"><?php esc_html_e( 'Perhaps searching, or one of the links below, can help.', 'dfd' ) ?></p>
				<p class="button-on-page"><a class="wc-backward" href="<?php echo home_url(); ?>"><?php esc_html_e( 'Go to homepage', 'dfd' ) ?></a></p>
			</div>
		</div>
	</div>
	...
	<div class="container-shortcodes row">
		<div class="columns six">
			<div class="arhives404 eight">
				<p class="label-form"><?php esc_html_e( 'Search in archives', 'dfd' ) ?></p>
				<div class="arhives">
		...
		<div class="columns six">
			<div class="search404 eight">
				<p class="label-form"><?php esc_html_e( 'Search on site', 'dfd' ) ?></p>
				<?php get_search_form(); ?>
			</div>
		</div>
	</div>
