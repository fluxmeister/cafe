...
<div class="portfolio-custom-hover">
	<?php switch($options['dfd_gallery_hover_main_dedcoration']) {
			...
			case 'plus':
			?>
				<a class="plus-link <?php echo esc_attr($options['dfd_gallery_hover_plus_position']) ?>" href="<?php echo esc_url($link_url) ?>" <?php echo wp_kses_data($thumb_data_attr) ?> title="<?php echo esc_attr($description) ?>" <?php echo wp_kses_data($data_gallery) ?>>
			...
			case 'lines':
			?>
				<a class="dfd-dotted-link"  href="<?php echo esc_url($link_url) ?>" <?php echo wp_kses_data($thumb_data_attr) ?> title="<?php echo esc_attr($description) ?>" <?php echo wp_kses_data($data_gallery) ?>>
			...
			case 'dots':
			?>
				<a class="dfd-dots-link"  href="<?php echo esc_url($link_url) ?>" <?php echo wp_kses_data($thumb_data_attr) ?> title="<?php echo esc_attr($description) ?>" <?php echo wp_kses_data($data_gallery) ?>>
				...
				<div class="title-wrap <?php echo esc_attr($options['dfd_gallery_hover_title_dedcoration']) ?>">
					<?php if($options['dfd_gallery_hover_show_title'] == 'on') : ?>
						<h6 class="widget-title">
							<a href="<?php echo esc_url($link_url) ?>" <?php echo wp_kses_data($thumb_data_attr) ?> title="<?php echo esc_attr($description) ?>" <?php echo wp_kses_data($data_gallery) ?>><?php echo esc_html($title) ?></a>
						</h6>
					<?php endif; ?>
