...
<div class="dfd-potfolio-wrap">
	...
	<div class="dfd-portfolio dfd-portfolio-<?php echo esc_attr($options['archive_folio_layout_style']) ?> <?php echo esc_attr($page_class) ?>" <?php echo wp_kses_data($data_atts) ?>>
						...
						<?php if($options['archive_folio_show_read_more_share'] == 'on') : ?>
							<div class="dfd-read-share clearfix">
								<div class="read-more-wrap">
									<a href="<?php the_permalink(); ?>" class="more-button <?php echo esc_attr($options['archive_folio_read_more_style']) ?>" title="<?php __('Read more','dfd') ?>" data-lang="en"><?php esc_html_e('More', 'dfd'); ?></a>
								</div>
