		...
		$sort_panel_html .= '<div class="clearfix">';
			$sort_panel_html .= '<div class="sort-panel '.esc_attr($options['blog_sort_panel_align']).'">';
				$sort_panel_html .= '<ul class="filter">';
					$sort_panel_html .= '<li class="active"><a data-filter=".post" href="#">'. esc_html__('All', 'dfd') .'</a></li>';
...
<div class="dfd-blog-wrap">
	<?php echo !empty($sort_panel_html) ? $sort_panel_html : ''; ?>
	<div id="dfd-blog-loop" class="dfd-blog dfd-blog-<?php echo esc_attr($options['blog_layout_style']) ?> <?php echo esc_attr($additiional_class) ?>" <?php echo wp_kses_data($data_atts) ?>>
		<?php
		...
		while ($wp_query->have_posts()) : $wp_query->the_post();
			...
			?>
			<div class="<?php echo esc_attr($post_class) ?>" <?php echo wp_kses_data($article_tags_classes); ?>>
				<div class="cover <?php echo esc_attr($cover_class) ?>" <?php echo wp_kses_data($animation_data) ?>>
					...
					<?php if($show_read_more_share == 'on') : ?>
						<div class="dfd-read-share clearfix">
							<div class="read-more-wrap">
								<a href="<?php the_permalink(); ?>" class="more-button <?php echo esc_attr($options['blog_read_more_style']) ?>" title="<?php __('Read more','dfd') ?>" data-lang="en"><?php esc_html_e('More', 'dfd'); ?></a>
							</div>
