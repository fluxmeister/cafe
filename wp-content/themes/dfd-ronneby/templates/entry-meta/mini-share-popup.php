...
<div class="dfd-share-popup-wrap">
	...
	<ul class="entry-share-popup rrssb-buttons" data-share="1" data-directory="<?php echo get_template_directory_uri(); ?>"<?php /* style="display: none;" */?>>
		...
		<li class="rrssb-pinterest">
			...
			<span class="box-name"><?php esc_html_e('Pinterest', 'dfd') ?></span>
		</li>
		<?php endif; ?>
	</ul>
</div>