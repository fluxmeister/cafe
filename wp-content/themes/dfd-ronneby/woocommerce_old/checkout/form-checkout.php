...
if ( ! $checkout->is_registration_enabled() && $checkout->is_registration_required() && ! is_user_logged_in() ) {
	echo esc_html( apply_filters( 'woocommerce_checkout_must_be_logged_in_message', __( 'You must be logged in to checkout.', 'dfd' ) ) );
	return;
}
	...
	<?php if ( $checkout->get_checkout_fields() ) : ?>
		...
		<div class="five columns">
			...
			<div class="checkout-details-cover">
				...
				<div class="box-name" id="order_review_heading"><?php esc_html_e( 'Your order', 'dfd' ); ?></div>
