						...
						<article class="four columns">
							<div class="dfd-vertical-aligned">
								...
								<div class="entry-content">
									<p><?php echo Dfd_Ronneby_Front_Helpers::cutString(get_the_excerpt(), 150); ?></p>
									<a href="<?php the_permalink(); ?>" class="more-button chaffle" title="<?php esc_attr_e('More', 'dfd') ?>" data-lang="en"><?php esc_html_e('More', 'dfd'); ?></a>
								</div>
							</div>
