							...
							<div class="six columns post-data">
								<div class="clearfix dfd-vertical-aligned">
									...
									<div class="entry-content">
										...
										<a href="<?php echo the_permalink(); ?>" title="<?php the_title(); ?>" class="more-button <?php echo esc_attr($read_more_style); ?> right" data-lang="en"><?php esc_html_e('Continue', 'dfd'); ?></a>
