...
class crum_tags_widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            array( 'description' => esc_html__( 'Displays tags list', 'dfd' ), ) // Args
        );
    }
	...
	function widget( $args, $instance ) {
		...
		<?php if(isset($read_all) && $read_all) : ?>
			<div class="read-more-section">
				<a href="#" class="subtitle"><?php esc_html_e('All tags','dfd'); ?></a>
			</div>
		<?php endif; ?>
		...
		<script type="text/javascript">
			(function($) {
				...
				$(document).ready(function() {
					...
					var new_content = '<?php echo wp_kses_post($output) ?>';
	...
	?>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e('Number of tags:', 'dfd'); ?></label>
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>"/>
		</p>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e('All tags button:', 'dfd'); ?></label>
