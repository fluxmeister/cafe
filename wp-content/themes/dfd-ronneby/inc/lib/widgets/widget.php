...
require_once get_template_directory().'/inc/lib/widgets/simplecsswidgets.php';
...
class SB_WP_Widget extends WP_Widget {
	...
	<p>
        ...
        <textarea class="widefat" id="<?php echo esc_attr($input_id); ?>" name="<?php echo esc_attr($input_name); ?>"><?php echo wp_kses_post($value); ?></textarea>
    </p>
	<?php
	}
	...
	protected function _input_wp_dropdown_categories($name) {
		...
		echo '<option value="">'.esc_html__('All categories' , 'dfd').'</option>';
