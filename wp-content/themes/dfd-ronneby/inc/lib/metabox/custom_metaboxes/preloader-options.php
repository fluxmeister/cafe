	...
	$meta_boxes[] = array(
		...
		'fields'     => array(
			array(
				...
				'name'    => esc_attr__( 'Site preloader', 'dfd' ),
                'tooltip_text' => esc_html__('This option allows you to enable or disable the preloader for the site. When enabled the visitor will first see the preloader and then fully loaded page', 'dfd'),
				'options' => array(
					array(
			...
			array(
				...
				'std'     => '',
				'options' => Dfd_Theme_Helpers::preloader_animation_style_cmb(),
