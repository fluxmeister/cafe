...
if (isset($dfd_ronneby['body_bg_color']) && $dfd_ronneby['body_bg_color']) {
    echo 'body,body.archive{ background-color: '.esc_attr($dfd_ronneby['body_bg_color']).' !important; }';
}
...
if (isset($dfd_ronneby['lightbox_elements_color']) && $dfd_ronneby['lightbox_elements_color']){
	...
	if(method_exists('Dfd_Theme_Helpers', 'dfd_hex2rgb')) {
		$fade_color = Dfd_Theme_Helpers::dfd_hex2rgb($dfd_ronneby['lightbox_elements_color'], .15);
		$desc_color = Dfd_Theme_Helpers::dfd_hex2rgb($dfd_ronneby['lightbox_elements_color'], .5);
	}
