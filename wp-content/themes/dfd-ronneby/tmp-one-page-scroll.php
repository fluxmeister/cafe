...
<section id="layout" class="no-title one-page-scroll <?php echo esc_attr($animation_style_class); ?>" data-enable-dots="<?php echo esc_attr($enable_dots) ?>" data-enable-animation="<?php echo esc_attr($enable_animation) ?>" <?php 
		if($smart_header == 'on') {
