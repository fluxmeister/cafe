...
//			if($(window).width() + scrollbarWidth < 1101) {
			if($('body div').is('#header-container')) {
...
//								}
	...
	if($container.length > 0) {
		if($headerContainer.length > 0 && $container.data('smart-header') && $container.data('smart-header') == '1' && ($headerContainer.hasClass('header-style-2')
			...
			|| $headerContainer.hasClass('header-style-14'))) {
		...
		$(window).load(function() {
			...
			if($('#layout').hasClass('one-page-scroll') && $('.vc_tta-accordion').length > 0) {
				$('.vc_tta-accordion').find('.vc_tta-panel .vc_tta-panel-heading a').on('click', function() {
					$container.find('> div.vc_vc_row:not(.section)').addClass('section');
					$.fn.fullpage.destroy('all');
					dfdInitOnePage();
					setTimeout(function(){
